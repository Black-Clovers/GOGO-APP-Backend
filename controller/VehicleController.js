...
const  addvehicle =(req, res)=>{
    ...
    const {owner_id, owner_name, owner_nic,owner_address,mobile_no,mobile_otp,vehicle_img,vehicle_no,chasse_no, lisence_no, vehicle_type, reg_date} = req.body;
    ...
    //create Vehicle
    newvehicleregister.save().then((createvehicle)=>{
...
//updateVehicle
  const updateVehicle = async (req, res) => {
    ...
    try {
      ...
      const cor = await VehicleRegModel.findByIdAndUpdate(vehicleId, {owner_id,owner_name,owner_nic,owner_address,mobile_no,mobile_otp,vehicle_img,vehicle_no,chasse_no,lisence_no,vehicle_type,reg_date});

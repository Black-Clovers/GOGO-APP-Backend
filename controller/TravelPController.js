...
//update
  const updatePackage = async (req, res) => {
    ...
    try {
      ...
      const cor = await travelpackage.findByIdAndUpdate(packageId, {package_id,package_name,vehicle_type,package_overview,package_include,contacts,image_url,add_info,price});

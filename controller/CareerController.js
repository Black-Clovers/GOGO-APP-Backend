...
const addVacancy = (req,res) =>{
    const {Vacancy_Id, Vacancy_Category, Vacancy_Position, No_of_Positions, Details, Vacancy_Type, Date_Posted, Location, Salary} = req.body;
    ...
    newVacancy.save().then((createdVacancy)=>{
...
const {Vacancy_Id, Vacancy_Category, Vacancy_Position, No_of_Positions, Details, Vacancy_Type, Date_Posted, Location, Salary} = req.body;
const Vaca = await Vacancy.findByIdAndUpdate(Vacancy_id,{Vacancy_Id, Vacancy_Category, Vacancy_Position, No_of_Positions, Details, Vacancy_Type, Date_Posted, Location, Salary});
